...
# Straight from GIT
#bash <( curl -qfsSL "https://raw.githubusercontent.com/Azathothas/Arsenal/main/aki/scripts/aki_bbot_secrets_yml_checker.sh") -a "/path/to/bbot/secrets.yml" --quota
...
if ! command -v jq >/dev/null 2>&1; then
    ...
    curl -qfsSL "https://raw.githubusercontent.com/Azathothas/Toolpacks/main/x86_64/jq" -o "/tmp/aki/bin/jq"
    chmod +xwr "/tmp/aki/bin/jq"
fi
#yq, for parsing yaml
if ! command -v yq >/dev/null 2>&1; then
    echo -e "➼ ${PINK}yq${NC} is ${RED}not installed${NC}. ${GREEN}Installing...${NC}"
    curl -qfsSL "https://raw.githubusercontent.com/Azathothas/Toolpacks/main/x86_64/yq" -o "/tmp/aki/bin/yq"
