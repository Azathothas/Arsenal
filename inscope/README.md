...
!# Without ROOT
curl -qfsSL "https://bin.ajam.dev/x86_64_Linux/inscope" -o "$HOME/bin/inscope" && chmod +xwr "$HOME/bin/inscope"
eget "https://bin.ajam.dev/x86_64_Linux/inscope" --to "$HOME/bin/inscope"
