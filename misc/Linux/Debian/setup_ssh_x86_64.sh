...
#scp
  install_scp()
  {
       sudo curl -qfsSL "https://raw.githubusercontent.com/Azathothas/Toolpacks/main/x86_64/scp" -o "$BINARY_ROOT_DIR/scp" || curl -qfsSL "https://raw.githubusercontent.com/Azathothas/Toolpacks/main/x86_64/scp" -o "$BINARY_HOME_DIR/ssh"
...
#sftp
  install_sftp()
  {
     sudo curl -qfsSL "https://raw.githubusercontent.com/Azathothas/Toolpacks/main/x86_64/sftp" -o "$BINARY_ROOT_DIR/sftp" || curl -qfsSL "https://raw.githubusercontent.com/Azathothas/Toolpacks/main/x86_64/sftp" -o "$BINARY_HOME_DIR/sftp"
...
#SSH
  install_ssh()
  {
     sudo curl -qfsSL "https://raw.githubusercontent.com/Azathothas/Toolpacks/main/x86_64/ssh" -o "$BINARY_ROOT_DIR/ssh" || curl -qfsSL "https://raw.githubusercontent.com/Azathothas/Toolpacks/main/x86_64/ssh" -o "$BINARY_HOME_DIR/ssh"
...
#ssh-keyscan
  install_ssh_keyscan()
  {
     sudo curl -qfsSL "https://raw.githubusercontent.com/Azathothas/Toolpacks/main/x86_64/ssh-keyscan" -o "$BINARY_ROOT_DIR/ssh-keyscan" || curl -qfsSL "https://raw.githubusercontent.com/Azathothas/Toolpacks/main/x86_64/ssh-keyscan" -o "$BINARY_HOME_DIR/ssh-keyscan"
...
#ssh-keygen
  create_host_keys()
  {
       sudo curl -qfsSL "https://raw.githubusercontent.com/Azathothas/Toolpacks/main/x86_64/ssh-keygen" -o "$BINARY_ROOT_DIR/ssh-keygen" || curl -qfsSL "https://raw.githubusercontent.com/Azathothas/Toolpacks/main/x86_64/ssh-keygen" -o "$BINARY_HOME_DIR/ssh-keygen"
