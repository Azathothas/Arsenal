...
#asn
 sudo curl -qfsSL "https://bin.ajam.dev/aarch64_arm64_Linux/asn" -o "$INSTALL_DIR/asn" && sudo chmod +xwr "$INSTALL_DIR/asn" &
#asnmap
 sudo curl -qfsSL "https://bin.ajam.dev/aarch64_arm64_Linux/asnmap" -o "$INSTALL_DIR/asnmap" && sudo chmod +xwr "$INSTALL_DIR/asnmap" &
...
#csvtk
 sudo curl -qfsSL "https://bin.ajam.dev/aarch64_arm64_Linux/csvtk" -o "$INSTALL_DIR/csvtk" && sudo chmod +xwr "$INSTALL_DIR/csvtk" &
#cut-cdn
 sudo curl -qfsSL "https://bin.ajam.dev/aarch64_arm64_Linux/cut-cdn" -o "$INSTALL_DIR/cut-cdn" && sudo chmod +xwr "$INSTALL_DIR/cut-cdn" & 
...
#dirstat-rs
 sudo curl -qfsSL "https://bin.ajam.dev/aarch64_arm64_Linux/ds" -o "$INSTALL_DIR/ds" && sudo chmod +xwr "$INSTALL_DIR/ds" &
...
#duf
 sudo curl -qfsSL "https://bin.ajam.dev/aarch64_arm64_Linux/duf" -o "$INSTALL_DIR/duf" && sudo chmod +xwr "$INSTALL_DIR/duf" &
#dust
 sudo curl -qfsSL "https://bin.ajam.dev/aarch64_arm64_Linux/dust" -o "$INSTALL_DIR/dust" && sudo chmod +xwr "$INSTALL_DIR/dust" &
#dysk
 sudo curl -qfsSL "https://bin.ajam.dev/aarch64_arm64_Linux/dysk" -o "$INSTALL_DIR/dysk" && sudo chmod +xwr "$INSTALL_DIR/dysk" &
#dust
 sudo curl -qfsSL "https://bin.ajam.dev/aarch64_arm64_Linux/dust" -o "$INSTALL_DIR/dust" && sudo chmod +xwr "$INSTALL_DIR/dust" &
#eget
...
#nomore403 : https://github.com/devploit/nomore403
 sudo curl -qfsSL "https://bin.ajam.dev/aarch64_arm64_Linux/nomore403" -o "$INSTALL_DIR/nomore403" && sudo chmod +xwr "$INSTALL_DIR/nomore403" & 
...
#ppmap : https://github.com/kleiton0x00/ppmap
 sudo curl -qfsSL "https://bin.ajam.dev/aarch64_arm64_Linux/ppmap" -o "$INSTALL_DIR/ppmap" && sudo chmod +xwr "$INSTALL_DIR/ppmap" &
...
#scopegen
 sudo curl -qfsSL "https://bin.ajam.dev/aarch64_arm64_Linux/scopegen" -o "$INSTALL_DIR/scopegen" && sudo chmod +xwr "$INSTALL_DIR/scopegen" &
#scopeview
...
#spk
 sudo curl -qfsSL "https://bin.ajam.dev/aarch64_arm64_Linux/spk" -o "$INSTALL_DIR/spk" && sudo chmod +xwr "$INSTALL_DIR/spk" &
